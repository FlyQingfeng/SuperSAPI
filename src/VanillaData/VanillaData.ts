...
/**
 * MinecraftParticleTypes enum.
 */
export enum MinecraftParticleTypes {
    ...
    breeze_ground_particle = "minecraft:breeze_ground_particle",
    breeze_wind_explosion_emitter = "minecraft:breeze_wind_explosion_emitter",
    ...
    infested_ambient = "minecraft:infested_ambient",
    infested_emitter = "minecraft:infested_emitter",
    ...
    raid_omen_ambient = "minecraft:raid_omen_ambient",
    raid_omen_emitter = "minecraft:raid_omen_emitter",
    ...
    small_flame_particle = "minecraft:small_flame_particle",
    ...
    stalactite_lava_drip_particle = "minecraft:stalactite_lava_drip_particle",
    stalactite_water_drip_particle = "minecraft:stalactite_water_drip_particle",
    stunned_emitter = "minecraft:stunned_emitter",
    totem_manual = "minecraft:totem_manual",
    totem_particle = "minecraft:totem_particle",
    trial_omen_ambient = "minecraft:trial_omen_ambient",
    trial_omen_emitter = "minecraft:trial_omen_emitter",
    trial_omen_single = "minecraft:trial_omen_single",
    ...
    vault_connection_particle = "minecraft:vault_connection_particle",
    ...
    weaving_ambient = "minecraft:weaving_ambient",
    weaving_emitter = "minecraft:weaving_emitter",
    white_smoke_particle = "minecraft:white_smoke_particle",
    wind_charged_ambient = "minecraft:wind_charged_ambient",
    wind_charged_emitter = "minecraft:wind_charged_emitter",
    wind_explosion_emitter = "minecraft:wind_explosion_emitter",
