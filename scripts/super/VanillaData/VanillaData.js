...
(function (MinecraftBlockTypes) {
    ...
    MinecraftBlockTypes["DeprecatedAnvil"] = "minecraft:deprecated_anvil";
    MinecraftBlockTypes["DeprecatedPurpurBlock1"] = "minecraft:deprecated_purpur_block_1";
    MinecraftBlockTypes["DeprecatedPurpurBlock2"] = "minecraft:deprecated_purpur_block_2";
...
(function (MinecraftItemTypes) {
    ...
    MinecraftItemTypes["Air"] = "minecraft:air";
...
(function (MinecraftPotionEffectTypes) {
    MinecraftPotionEffectTypes["FireResistance"] = "FireResistance";
    MinecraftPotionEffectTypes["Harming"] = "Harming";
    MinecraftPotionEffectTypes["Healing"] = "Healing";
    MinecraftPotionEffectTypes["Infested"] = "Infested";
    MinecraftPotionEffectTypes["Invisibility"] = "Invisibility";
    MinecraftPotionEffectTypes["Leaping"] = "Leaping";
    MinecraftPotionEffectTypes["NightVision"] = "NightVision";
    MinecraftPotionEffectTypes["None"] = "None";
    MinecraftPotionEffectTypes["Oozing"] = "Oozing";
    MinecraftPotionEffectTypes["Poison"] = "Poison";
    MinecraftPotionEffectTypes["SlowFalling"] = "SlowFalling";
    MinecraftPotionEffectTypes["Slowing"] = "Slowing";
    MinecraftPotionEffectTypes["Strength"] = "Strength";
    MinecraftPotionEffectTypes["Swiftness"] = "Swiftness";
    MinecraftPotionEffectTypes["TurtleMaster"] = "TurtleMaster";
    MinecraftPotionEffectTypes["WaterBreath"] = "WaterBreath";
    MinecraftPotionEffectTypes["Weakness"] = "Weakness";
    MinecraftPotionEffectTypes["Weaving"] = "Weaving";
    MinecraftPotionEffectTypes["WindCharged"] = "WindCharged";
    MinecraftPotionEffectTypes["Wither"] = "Wither";
})(MinecraftPotionEffectTypes || (MinecraftPotionEffectTypes = {}));
/**
 * All possible MinecraftPotionLiquidTypes
 */
export var MinecraftPotionLiquidTypes;
(function (MinecraftPotionLiquidTypes) {
    MinecraftPotionLiquidTypes["Lingering"] = "Lingering";
    MinecraftPotionLiquidTypes["Regular"] = "Regular";
    MinecraftPotionLiquidTypes["Splash"] = "Splash";
})(MinecraftPotionLiquidTypes || (MinecraftPotionLiquidTypes = {}));
/**
 * All possible MinecraftPotionModifierTypes
 */
export var MinecraftPotionModifierTypes;
(function (MinecraftPotionModifierTypes) {
    MinecraftPotionModifierTypes["Long"] = "Long";
    MinecraftPotionModifierTypes["Normal"] = "Normal";
    MinecraftPotionModifierTypes["Strong"] = "Strong";
})(MinecraftPotionModifierTypes || (MinecraftPotionModifierTypes = {}));
/**
 * MinecraftParticleTypes enum.
 */
export var MinecraftParticleTypes;
(function (MinecraftParticleTypes) {
    MinecraftParticleTypes["arrow_spell_emitter"] = "minecraft:arrow_spell_emitter";
    MinecraftParticleTypes["balloon_gas_particle"] = "minecraft:balloon_gas_particle";
    MinecraftParticleTypes["basic_bubble_particle"] = "minecraft:basic_bubble_particle";
    MinecraftParticleTypes["basic_bubble_particle_manual"] = "minecraft:basic_bubble_particle_manual";
    MinecraftParticleTypes["basic_crit_particle"] = "minecraft:basic_crit_particle";
    MinecraftParticleTypes["basic_flame_particle"] = "minecraft:basic_flame_particle";
    MinecraftParticleTypes["basic_portal_particle"] = "minecraft:basic_portal_particle";
    MinecraftParticleTypes["basic_smoke_particle"] = "minecraft:basic_smoke_particle";
    MinecraftParticleTypes["bleach"] = "minecraft:bleach";
    MinecraftParticleTypes["block_destruct"] = "minecraft:block_destruct";
    MinecraftParticleTypes["block_slide"] = "minecraft:block_slide";
    MinecraftParticleTypes["blue_flame_particle"] = "minecraft:blue_flame_particle";
    MinecraftParticleTypes["breaking_item_icon"] = "minecraft:breaking_item_icon";
    MinecraftParticleTypes["breaking_item_terrain"] = "minecraft:breaking_item_terrain";
    MinecraftParticleTypes["breeze_ground_particle"] = "minecraft:breeze_ground_particle";
    MinecraftParticleTypes["breeze_wind_explosion_emitter"] = "minecraft:breeze_wind_explosion_emitter";
    MinecraftParticleTypes["bubble_column_bubble"] = "minecraft:bubble_column_bubble";
    MinecraftParticleTypes["bubble_column_down_particle"] = "minecraft:bubble_column_down_particle";
    MinecraftParticleTypes["bubble_column_up_particle"] = "minecraft:bubble_column_up_particle";
    MinecraftParticleTypes["camera_shoot_explosion"] = "minecraft:camera_shoot_explosion";
    MinecraftParticleTypes["campfire_smoke_particle"] = "minecraft:campfire_smoke_particle";
    MinecraftParticleTypes["campfire_tall_smoke_particle"] = "minecraft:campfire_tall_smoke_particle";
    MinecraftParticleTypes["candle_flame_particle"] = "minecraft:candle_flame_particle";
    MinecraftParticleTypes["cauldron_bubble_particle"] = "minecraft:cauldron_bubble_particle";
    MinecraftParticleTypes["cauldron_explosion_emitter"] = "minecraft:cauldron_explosion_emitter";
    MinecraftParticleTypes["cauldron_spell_emitter"] = "minecraft:cauldron_spell_emitter";
    MinecraftParticleTypes["cauldron_splash_particle"] = "minecraft:cauldron_splash_particle";
    MinecraftParticleTypes["cherry_leaves_particle"] = "minecraft:cherry_leaves_particle";
    MinecraftParticleTypes["colored_flame_particle"] = "minecraft:colored_flame_particle";
    MinecraftParticleTypes["conduit_absorb_particle"] = "minecraft:conduit_absorb_particle";
    MinecraftParticleTypes["conduit_attack_emitter"] = "minecraft:conduit_attack_emitter";
    MinecraftParticleTypes["conduit_particle"] = "minecraft:conduit_particle";
    MinecraftParticleTypes["critical_hit_emitter"] = "minecraft:critical_hit_emitter";
    MinecraftParticleTypes["crop_growth_area_emitter"] = "minecraft:crop_growth_area_emitter";
    MinecraftParticleTypes["crop_growth_emitter"] = "minecraft:crop_growth_emitter";
    MinecraftParticleTypes["death_explosion_emitter"] = "minecraft:death_explosion_emitter";
    MinecraftParticleTypes["dolphin_move_particle"] = "minecraft:dolphin_move_particle";
    MinecraftParticleTypes["dragon_breath_fire"] = "minecraft:dragon_breath_fire";
    MinecraftParticleTypes["dragon_breath_lingering"] = "minecraft:dragon_breath_lingering";
    MinecraftParticleTypes["dragon_breath_trail"] = "minecraft:dragon_breath_trail";
    MinecraftParticleTypes["dragon_death_explosion_emitter"] = "minecraft:dragon_death_explosion_emitter";
    MinecraftParticleTypes["dragon_destroy_block"] = "minecraft:dragon_destroy_block";
    MinecraftParticleTypes["dragon_dying_explosion"] = "minecraft:dragon_dying_explosion";
    MinecraftParticleTypes["dust_plume"] = "minecraft:dust_plume";
    MinecraftParticleTypes["egg_destroy_emitter"] = "minecraft:egg_destroy_emitter";
    MinecraftParticleTypes["electric_spark_particle"] = "minecraft:electric_spark_particle";
    MinecraftParticleTypes["elephant_tooth_paste_vapor_particle"] = "minecraft:elephant_tooth_paste_vapor_particle";
    MinecraftParticleTypes["enchanting_table_particle"] = "minecraft:enchanting_table_particle";
    MinecraftParticleTypes["end_chest"] = "minecraft:end_chest";
    MinecraftParticleTypes["endrod"] = "minecraft:endrod";
    MinecraftParticleTypes["evocation_fang_particle"] = "minecraft:evocation_fang_particle";
    MinecraftParticleTypes["evoker_spell"] = "minecraft:evoker_spell";
    MinecraftParticleTypes["explosion_manual"] = "minecraft:explosion_manual";
    MinecraftParticleTypes["explosion_particle"] = "minecraft:explosion_particle";
    MinecraftParticleTypes["eye_of_ender_bubble_particle"] = "minecraft:eye_of_ender_bubble_particle";
    MinecraftParticleTypes["eyeofender_death_explode_particle"] = "minecraft:eyeofender_death_explode_particle";
    MinecraftParticleTypes["falling_border_dust_particle"] = "minecraft:falling_border_dust_particle";
    MinecraftParticleTypes["falling_dust"] = "minecraft:falling_dust";
    MinecraftParticleTypes["falling_dust_concrete_powder_particle"] = "minecraft:falling_dust_concrete_powder_particle";
    MinecraftParticleTypes["falling_dust_dragon_egg_particle"] = "minecraft:falling_dust_dragon_egg_particle";
    MinecraftParticleTypes["falling_dust_gravel_particle"] = "minecraft:falling_dust_gravel_particle";
    MinecraftParticleTypes["falling_dust_red_sand_particle"] = "minecraft:falling_dust_red_sand_particle";
    MinecraftParticleTypes["falling_dust_sand_particle"] = "minecraft:falling_dust_sand_particle";
    MinecraftParticleTypes["falling_dust_scaffolding_particle"] = "minecraft:falling_dust_scaffolding_particle";
    MinecraftParticleTypes["falling_dust_top_snow_particle"] = "minecraft:falling_dust_top_snow_particle";
    MinecraftParticleTypes["fish_hook_particle"] = "minecraft:fish_hook_particle";
    MinecraftParticleTypes["fish_pos_particle"] = "minecraft:fish_pos_particle";
    MinecraftParticleTypes["glow_particle"] = "minecraft:glow_particle";
    MinecraftParticleTypes["guardian_attack_particle"] = "minecraft:guardian_attack_particle";
    MinecraftParticleTypes["guardian_water_move_particle"] = "minecraft:guardian_water_move_particle";
    MinecraftParticleTypes["heart_particle"] = "minecraft:heart_particle";
    MinecraftParticleTypes["honey_drip_particle"] = "minecraft:honey_drip_particle";
    MinecraftParticleTypes["huge_explosion_emitter"] = "minecraft:huge_explosion_emitter";
    MinecraftParticleTypes["huge_explosion_lab_misc_emitter"] = "minecraft:huge_explosion_lab_misc_emitter";
    MinecraftParticleTypes["ice_evaporation_emitter"] = "minecraft:ice_evaporation_emitter";
    MinecraftParticleTypes["infested_ambient"] = "minecraft:infested_ambient";
    MinecraftParticleTypes["infested_emitter"] = "minecraft:infested_emitter";
    MinecraftParticleTypes["ink_emitter"] = "minecraft:ink_emitter";
    MinecraftParticleTypes["knockback_roar_particle"] = "minecraft:knockback_roar_particle";
    MinecraftParticleTypes["lab_table_heatblock_dust_particle"] = "minecraft:lab_table_heatblock_dust_particle";
    MinecraftParticleTypes["lab_table_misc_mystical_particle"] = "minecraft:lab_table_misc_mystical_particle";
    MinecraftParticleTypes["large_explosion"] = "minecraft:large_explosion";
    MinecraftParticleTypes["lava_drip_particle"] = "minecraft:lava_drip_particle";
    MinecraftParticleTypes["lava_particle"] = "minecraft:lava_particle";
    MinecraftParticleTypes["llama_spit_smoke"] = "minecraft:llama_spit_smoke";
    MinecraftParticleTypes["magnesium_salts_emitter"] = "minecraft:magnesium_salts_emitter";
    MinecraftParticleTypes["misc_fire_vapor_particle"] = "minecraft:misc_fire_vapor_particle";
    MinecraftParticleTypes["mob_block_spawn_emitter"] = "minecraft:mob_block_spawn_emitter";
    MinecraftParticleTypes["mob_portal"] = "minecraft:mob_portal";
    MinecraftParticleTypes["mobflame_emitter"] = "minecraft:mobflame_emitter";
    MinecraftParticleTypes["mobflame_single"] = "minecraft:mobflame_single";
    MinecraftParticleTypes["mobspell_ambient"] = "minecraft:mobspell_ambient";
    MinecraftParticleTypes["mobspell_emitter"] = "minecraft:mobspell_emitter";
    MinecraftParticleTypes["mycelium_dust_particle"] = "minecraft:mycelium_dust_particle";
    MinecraftParticleTypes["nectar_drip_particle"] = "minecraft:nectar_drip_particle";
    MinecraftParticleTypes["note_particle"] = "minecraft:note_particle";
    MinecraftParticleTypes["obsidian_glow_dust_particle"] = "minecraft:obsidian_glow_dust_particle";
    MinecraftParticleTypes["obsidian_tear_particle"] = "minecraft:obsidian_tear_particle";
    MinecraftParticleTypes["ominous_spawning_particle"] = "minecraft:ominous_spawning_particle";
    MinecraftParticleTypes["oozing_ambient"] = "minecraft:oozing_ambient";
    MinecraftParticleTypes["oozing_emitter"] = "minecraft:oozing_emitter";
    MinecraftParticleTypes["phantom_trail_particle"] = "minecraft:phantom_trail_particle";
    MinecraftParticleTypes["portal_directional"] = "minecraft:portal_directional";
    MinecraftParticleTypes["portal_east_west"] = "minecraft:portal_east_west";
    MinecraftParticleTypes["portal_north_south"] = "minecraft:portal_north_south";
    MinecraftParticleTypes["portal_reverse_particle"] = "minecraft:portal_reverse_particle";
    MinecraftParticleTypes["raid_omen_ambient"] = "minecraft:raid_omen_ambient";
    MinecraftParticleTypes["raid_omen_emitter"] = "minecraft:raid_omen_emitter";
    MinecraftParticleTypes["rain_splash_particle"] = "minecraft:rain_splash_particle";
    MinecraftParticleTypes["redstone_ore_dust_particle"] = "minecraft:redstone_ore_dust_particle";
    MinecraftParticleTypes["redstone_repeater_dust_particle"] = "minecraft:redstone_repeater_dust_particle";
    MinecraftParticleTypes["redstone_torch_dust_particle"] = "minecraft:redstone_torch_dust_particle";
    MinecraftParticleTypes["redstone_wire_dust_particle"] = "minecraft:redstone_wire_dust_particle";
    MinecraftParticleTypes["rising_border_dust_particle"] = "minecraft:rising_border_dust_particle";
    MinecraftParticleTypes["sculk_charge_particle"] = "minecraft:sculk_charge_particle";
    MinecraftParticleTypes["sculk_charge_pop_particle"] = "minecraft:sculk_charge_pop_particle";
    MinecraftParticleTypes["sculk_sensor_redstone_particle"] = "minecraft:sculk_sensor_redstone_particle";
    MinecraftParticleTypes["sculk_soul_particle"] = "minecraft:sculk_soul_particle";
    MinecraftParticleTypes["shriek_particle"] = "minecraft:shriek_particle";
    MinecraftParticleTypes["shulker_bullet"] = "minecraft:shulker_bullet";
    MinecraftParticleTypes["silverfish_grief_emitter"] = "minecraft:silverfish_grief_emitter";
    MinecraftParticleTypes["small_flame_particle"] = "minecraft:small_flame_particle";
    MinecraftParticleTypes["small_soul_fire_flame"] = "minecraft:small_soul_fire_flame";
    MinecraftParticleTypes["smash_ground_particle"] = "minecraft:smash_ground_particle";
    MinecraftParticleTypes["smash_ground_particle_center"] = "minecraft:smash_ground_particle_center";
    MinecraftParticleTypes["snowflake_particle"] = "minecraft:snowflake_particle";
    MinecraftParticleTypes["sonic_explosion"] = "minecraft:sonic_explosion";
    MinecraftParticleTypes["soul_particle"] = "minecraft:soul_particle";
    MinecraftParticleTypes["sparkler_emitter"] = "minecraft:sparkler_emitter";
    MinecraftParticleTypes["splash_spell_emitter"] = "minecraft:splash_spell_emitter";
    MinecraftParticleTypes["sponge_absorb_water_particle"] = "minecraft:sponge_absorb_water_particle";
    MinecraftParticleTypes["spore_blossom_ambient_particle"] = "minecraft:spore_blossom_ambient_particle";
    MinecraftParticleTypes["spore_blossom_shower_particle"] = "minecraft:spore_blossom_shower_particle";
    MinecraftParticleTypes["squid_flee_particle"] = "minecraft:squid_flee_particle";
    MinecraftParticleTypes["squid_ink_bubble"] = "minecraft:squid_ink_bubble";
    MinecraftParticleTypes["squid_move_particle"] = "minecraft:squid_move_particle";
    MinecraftParticleTypes["stalactite_lava_drip_particle"] = "minecraft:stalactite_lava_drip_particle";
    MinecraftParticleTypes["stalactite_water_drip_particle"] = "minecraft:stalactite_water_drip_particle";
    MinecraftParticleTypes["stunned_emitter"] = "minecraft:stunned_emitter";
    MinecraftParticleTypes["totem_manual"] = "minecraft:totem_manual";
    MinecraftParticleTypes["totem_particle"] = "minecraft:totem_particle";
    MinecraftParticleTypes["trial_omen_ambient"] = "minecraft:trial_omen_ambient";
    MinecraftParticleTypes["trial_omen_emitter"] = "minecraft:trial_omen_emitter";
    MinecraftParticleTypes["trial_omen_single"] = "minecraft:trial_omen_single";
    MinecraftParticleTypes["trial_spawner_detection"] = "minecraft:trial_spawner_detection";
    MinecraftParticleTypes["trial_spawner_detection_ominous"] = "minecraft:trial_spawner_detection_ominous";
    MinecraftParticleTypes["underwater_torch_particle"] = "minecraft:underwater_torch_particle";
    MinecraftParticleTypes["vault_connection_particle"] = "minecraft:vault_connection_particle";
    MinecraftParticleTypes["vibration_signal"] = "minecraft:vibration_signal";
    MinecraftParticleTypes["villager_angry"] = "minecraft:villager_angry";
    MinecraftParticleTypes["villager_happy"] = "minecraft:villager_happy";
    MinecraftParticleTypes["warden_dig"] = "minecraft:warden_dig";
    MinecraftParticleTypes["water_drip_particle"] = "minecraft:water_drip_particle";
    MinecraftParticleTypes["water_evaporation_actor_emitter"] = "minecraft:water_evaporation_actor_emitter";
    MinecraftParticleTypes["water_evaporation_bucket_emitter"] = "minecraft:water_evaporation_bucket_emitter";
    MinecraftParticleTypes["water_evaporation_manual"] = "minecraft:water_evaporation_manual";
    MinecraftParticleTypes["water_splash_particle"] = "minecraft:water_splash_particle";
    MinecraftParticleTypes["water_splash_particle_manual"] = "minecraft:water_splash_particle_manual";
    MinecraftParticleTypes["water_wake_particle"] = "minecraft:water_wake_particle";
    MinecraftParticleTypes["wax_particle"] = "minecraft:wax_particle";
    MinecraftParticleTypes["weaving_ambient"] = "minecraft:weaving_ambient";
    MinecraftParticleTypes["weaving_emitter"] = "minecraft:weaving_emitter";
    MinecraftParticleTypes["white_smoke_particle"] = "minecraft:white_smoke_particle";
    MinecraftParticleTypes["wind_charged_ambient"] = "minecraft:wind_charged_ambient";
    MinecraftParticleTypes["wind_charged_emitter"] = "minecraft:wind_charged_emitter";
    MinecraftParticleTypes["wind_explosion_emitter"] = "minecraft:wind_explosion_emitter";
    MinecraftParticleTypes["wither_boss_invulnerable"] = "minecraft:wither_boss_invulnerable";
})(MinecraftParticleTypes || (MinecraftParticleTypes = {}));
